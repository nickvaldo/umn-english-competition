    ...
    <div id="page-wrapper">
        <div class="container-fluid" style="padding-top: 2.0em">
            <div class="panel panel-info">
                <div class="panel-heading" style="font-size: 1.5em"> Title</div>
            </div>
            <!-- .row -->
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="white-box">
                        <h3 class="m-t-20 m-b-20"><b>Your Current Title is :</b></h3>
                        <h3 class="m-t-30 m-b-20">{{ $title->title }}</h3>
                        <!--<p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>-->
                        <a href="{{URL::to('/admin/title/edit/'.$title->id)}}"><button class="btn btn-success btn-rounded waves-effect waves-light m-t-20" data-toggle="tooltip" data-original-title="Edit Title">Click Here to Edit Current Title</button></a>
                    </div>
                </div>
            </div>
            <!-- /.row -->
