                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-wrapper collapse in" aria-expanded="true">
                            <div class="panel-body">
                                <form action="@if(!empty((array)$slide)) {{ URL::to('admin/sponsor/edit/'.$slide->id) }} @else {{ URL::to('admin/sponsor/add') }} @endif" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success" name="@if(!empty((array)$slide)){{'edit_sponsor_admin'}}@else{{'add_sponsor_admin'}}@endif"> <i class="fa fa-check"></i> Save</button>
