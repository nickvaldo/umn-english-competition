                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-wrapper collapse in" aria-expanded="true">
                            <div class="panel-body">
                                <form action="@if(!empty((array)$question)) {{ URL::to('admin/question/'.$term_id.'/add/'.$question->id) }} @else {{ URL::to('admin/question/'.$term_id.'/add') }} @endif" method="POST">
                                    {{ csrf_field() }}
                                    <div class="form-body">
                                        <div class="row">
                                          <div class="col-md-6">
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success" name="@if(!empty((array)$question)){{'add_question_admin'}}@else{{'add_question_admin'}}@endif"> <i class="fa fa-check"></i> Save</button>
