        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Logo</h4> </div>
            </div>
            <!--.row-->
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading"  style="font-size: 1.5em"> Logo Form</div>
                        <div class="panel-wrapper collapse in" aria-expanded="true">
                            <div class="panel-body">
                                <form action="@if(!empty((array)$logo)) {{ URL::to('admin/logo/edit/'.$logo->id) }} @else {{ URL::to('admin/logo/add') }} @endif" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 form-group <?php if($errors->has('image')) echo "has-error"; ?>">
                                                        ...
                                                        <input type="file" name="image" id="input-file-disable-remove" class="dropify" data-show-remove="false" data-default-file="@if(!empty((array)$logo)){{URL::to($logo->image)}}@else{{old('image')}}@endif"/>
                                                    ...
                                                    <div class="col-md-12 form-group <?php if($errors->has('alternative_description')) echo "has-error"; ?>">
                                                        ...
                                                        <div class="col-md-9">
                                                          <input type="text" class="form-control" name="alternative_description" placeholder="Description" value="@if(!empty((array)$logo)){{$logo->alternative_description}}@else{{old('alternative_description')}}@endif">
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success" name="@if(!empty((array)$logo)){{'edit_logo_admin'}}@else{{'add_logo_admin'}}@endif"> <i class="fa fa-check"></i> Save</button>
                                        <a href="{{URL::to('admin/logos')}}" style="color:#686868"><button type="button" class="btn btn-default">Cancel</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
