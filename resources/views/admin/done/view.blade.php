        ...
        <div class="container-fluid" style="padding-top: 2.0em">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="white-box">
                        <h3 class="m-t-20 m-b-20"><b>Your Current Done Page is :</b></h3>
                        <h3 class="m-t-40 m-b-20"><b>{{ $done->title }}</b></h3>
                        <h3 class="m-t-10 m-b-20" style="font-size: 1.6rem"><?php echo "$done->description"; ?></h3>
                        <!--<p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>-->
                        <a href="{{URL::to('/admin/done/edit/'.$done->id)}}"><button class="btn btn-success btn-rounded waves-effect waves-light m-t-20" data-toggle="tooltip" data-original-title="Edit Done">Click Here to Edit Current Done Page</button></a>
                    </div>
                </div>
            </div>
            <!-- /.row -->
