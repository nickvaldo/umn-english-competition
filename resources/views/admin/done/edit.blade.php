        ...
        <div class="container-fluid">
            <div class="row bg-rule">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-rule">Done Page</h4> </div>
            </div>
            <!--.row-->
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading"  style="font-size: 1.5em"> Done Page Form</div>
                        <div class="panel-wrapper collapse in" aria-expanded="true">
                            <div class="panel-body">
                                <form action="@if(!empty((array)$done)) {{ URL::to('admin/done/edit/'.$done->id) }}@endif" method="POST">
                                    {{ csrf_field() }}
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 form-group <?php if($errors->has('title')) echo "has-error"; ?>">
                                                        ...
                                                        <div class="col-md-9">
                                                          <input type="text" class="form-control" name="title" placeholder="Title" value="@if(!empty((array)$done)){{$done->title}}@else{{old('title')}}@endif">
                                                    ...
                                                    <div class="col-md-12 form-group <?php if($errors->has('description')) echo "has-error"; ?>">
                                                        <textarea id="mymce" name="description" placeholder="Enter your Rule here...">@if(!empty((array)$done)){{$done->description}}@else{{old('description')}}@endif</textarea>
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success" name="@if(!empty((array)$done)){{'edit_done_admin'}}@endif"> <i class="fa fa-check"></i> Save</button>
                                        <a href="{{URL::to('admin/done')}}" style="color:#686868"><button type="button" class="btn btn-default">Cancel</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
